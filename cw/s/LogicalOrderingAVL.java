...
// This is the insert function starting with a contains method analogy ----------------------------------------------------------------------------//
...
// the NODE class we have to put our locks in this is the class that will do the trick//
...
//-------------------------------------My added variables-------------------------------------------------------------------------------//
final public ReentrantReadWriteLock WS_lock;
final public MultiListNode ProcessListLink;
/**
...
WS_lock = new ReentrantReadWriteLock(true);
ProcessListLink = new MultiListNode();
